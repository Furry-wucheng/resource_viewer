...
mixin _$AppConfig {
 ...
 int get id; AppThemeMode get themeMode; PageDirection get pageDirection; DoublePageMode get doublePageMode; bool get crossChapter; int get cacheLimitMB; AutoSyncInterval get autoSyncInterval; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,themeMode,pageDirection,doublePageMode,crossChapter,cacheLimitMB,autoSyncInterval,updatedAt);

@override
String toString() {
  return 'AppConfig(id: $id, themeMode: $themeMode, pageDirection: $pageDirection, doublePageMode: $doublePageMode, crossChapter: $crossChapter, cacheLimitMB: $cacheLimitMB, autoSyncInterval: $autoSyncInterval, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, AppThemeMode themeMode, PageDirection pageDirection, DoublePageMode doublePageMode, bool crossChapter, int cacheLimitMB, AutoSyncInterval autoSyncInterval, DateTime updatedAt
});
...
/// Create a copy of AppConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? themeMode = null,Object? pageDirection = null,Object? doublePageMode = null,Object? crossChapter = null,Object? cacheLimitMB = null,Object? autoSyncInterval = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  AppThemeMode themeMode,  PageDirection pageDirection,  DoublePageMode doublePageMode,  bool crossChapter,  int cacheLimitMB,  AutoSyncInterval autoSyncInterval,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppConfig() when $default != null:
return $default(_that.id,_that.themeMode,_that.pageDirection,_that.doublePageMode,_that.crossChapter,_that.cacheLimitMB,_that.autoSyncInterval,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  AppThemeMode themeMode,  PageDirection pageDirection,  DoublePageMode doublePageMode,  bool crossChapter,  int cacheLimitMB,  AutoSyncInterval autoSyncInterval,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _AppConfig():
return $default(_that.id,_that.themeMode,_that.pageDirection,_that.doublePageMode,_that.crossChapter,_that.cacheLimitMB,_that.autoSyncInterval,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  AppThemeMode themeMode,  PageDirection pageDirection,  DoublePageMode doublePageMode,  bool crossChapter,  int cacheLimitMB,  AutoSyncInterval autoSyncInterval,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _AppConfig() when $default != null:
return $default(_that.id,_that.themeMode,_that.pageDirection,_that.doublePageMode,_that.crossChapter,_that.cacheLimitMB,_that.autoSyncInterval,_that.updatedAt);case _:
  return null;
...
class _AppConfig implements AppConfig {
  const _AppConfig({this.id = 1, this.themeMode = AppThemeMode.system, this.pageDirection = PageDirection.rightToLeft, this.doublePageMode = DoublePageMode.auto, this.crossChapter = true, this.cacheLimitMB = 500, this.autoSyncInterval = AutoSyncInterval.off, required this.updatedAt});
...
/// Create a copy of AppConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? themeMode = null,Object? pageDirection = null,Object? doublePageMode = null,Object? crossChapter = null,Object? cacheLimitMB = null,Object? autoSyncInterval = null,Object? updatedAt = null,}) {
